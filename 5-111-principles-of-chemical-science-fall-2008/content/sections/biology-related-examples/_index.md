...
menu:
  leftnav:
    identifier: d3155b63ec6743355375ea901b2a4f4e
    name: Biology Topics
    weight: 40
title: Biology Topics
type: course
uid: d3155b63ec6743355375ea901b2a4f4e
...
| L3 | Wave-particle duality of light | Quantum dot research at MIT ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect3)) | &nbsp; |
...
| L9 | Periodic trends | Alkali earth metals in the body: Na and K versus Li (lithiated 7-up) ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect9)) |  {{< br >}}{{< br >}} Selected biology-related questions based on Lecture 1-9. ([PDF]({{< baseurl >}}/sections/biology-related-examples/l1to9bio)) {{< br >}}{{< br >}} Answer key ([PDF]({{< baseurl >}}/sections/biology-related-examples/l1to9bio_key)) {{< br >}}{{< br >}}  |
| L10 | Periodic trends continued; covalent bonds | Atomic size: sodium ion channels in neurons ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect10)) | &nbsp; |
| L11 | Lewis structures |  {{< br >}}{{< br >}} Lewis sturucture examples: {{< br >}}{{< br >}} 1) Cyanide ion in cassava plants, cigarettes {{< br >}}{{< br >}} 2) Thionyl chloride for the synthesis of novacaine {{< br >}}{{< br >}} ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect11)) {{< br >}}{{< br >}}  | &nbsp; |
| L12 |  {{< br >}}{{< br >}} Exceptions to Lewis structure rules; Ionic bonds {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} 1) Free radicals in biology (in DNA damage _and_ essential for life) {{< br >}}{{< br >}} 2) Lewis structure example: Nitric Oxide (NO) in vasodilation (and Viagra) {{< br >}}{{< br >}} ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect12)) {{< br >}}{{< br >}}  | &nbsp; |
| L13 |  {{< br >}}{{< br >}} Polar covalent bonds; VSEPR theory {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} 1) Water versus fat-soluble vitamins (comparing folic acid and vitamin A) {{< br >}}{{< br >}} 2) Molecuar shape: importance in enzyme-substrate complexes {{< br >}}{{< br >}} ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect13)) {{< br >}}{{< br >}}  | &nbsp; |
| L14 | Molecular orbital theory |  {{< br >}}{{< br >}} 2008 Nobel Prize in chemistry: Green Flourescent Protein (GFP) ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect14)) {{< br >}}{{< br >}}  | &nbsp; |
| L15 | Valence bond theory and hybridization | Restriction of rotation around double bonds: application to drug design ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect15)) | &nbsp; |
| L16 |  {{< br >}}{{< br >}} Determining hybridization in complex molecules; Thermochemistry and bond energies / bond enthalpies {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} 1) Hybridization example: ascorbic acid (vitamin C) {{< br >}}{{< br >}} 2) Thermochemistry of glucose oxidation: harnessing energy from plants {{< br >}}{{< br >}} ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect16)) {{< br >}}{{< br >}}  | &nbsp; |
| L17 | Entropy and disorder |  {{< br >}}{{< br >}} 1) Hybridization example: identifying molecules that follow the "morphine rule" {{< br >}}{{< br >}} 2) ATP hydrolysis in the body {{< br >}}{{< br >}} ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect17)) {{< br >}}{{< br >}}  | &nbsp; |
| L18 | Free energy and control of spontaneity |  {{< br >}}{{< br >}} 1) ATP-coupled reactions in biology {{< br >}}{{< br >}} 2) Thermodynamics of hydrogen bonding: relevance to DNA replication {{< br >}}{{< br >}} ([PDF]({{< baseurl >}}/sections/biology-related-examples/bioex_lect18)) {{< br >}}{{< br >}}  | &nbsp; |
| L19 | Chemical equilibrium | &nbsp; |
| L20 | Le Chatelier's principle and applications to blood-oxygen levels |  {{< br >}}{{< br >}} 1) Maximizing the yield of nitrogen fixation: inspiration from bacteria {{< br >}}{{< br >}} 2) Le Chatelier's principle and hemoglobin: blood-oxygen levels {{< br >}}{{< br >}} ([PDF - 2.7 MB]({{< baseurl >}}/sections/biology-related-examples/bioex_lect20)) {{< br >}}{{< br >}}  |  {{< br >}}{{< br >}} Selected biology-related questions based on Lectures 10-20 ([PDF]({{< baseurl >}}/sections/biology-related-examples/l10to20bio)) {{< br >}}{{< br >}} Answer key ([PDF]({{< baseurl >}}/sections/biology-related-examples/l10to20bio_key)) {{< br >}}{{< br >}}  |
